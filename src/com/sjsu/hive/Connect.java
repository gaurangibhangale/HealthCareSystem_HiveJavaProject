...
public class Connect {
    ...
    private static String hiveHostName = "127.0.0.1"; //change this ip address if required
    private static String hiveForwardedPort = "2200"; //this is the port number, which is configured to forward to Sandbox's 10000 port


    public static void runQueryAndGetResult() throws SQLException{
         try {
